...
* **indent menu:** 修复了因为设置 fontSize 导致 text-indent 没法对齐的问题 ([a431d46](https://github.com/42how-dev/wangEditor/commit/a431d465ff929b331ebc2545aeb52e7ca3eba2d2))
* 部分菜单 disabled ([87f1233](https://github.com/42how-dev/wangEditor/commit/87f12332a087072406c1988dc5cef2eae8335375))
* 插入表格会删掉去掉 issue 4711 ([d4fac4e](https://github.com/42how-dev/wangEditor/commit/d4fac4efd06480457a95c2b06e7472cf6204de58))
...
* 分割线后无法输入内容 ([146fd05](https://github.com/42how-dev/wangEditor/commit/146fd05108592d50d036d0f37a2e29fcdd2a97be))
* 更新各包之间依赖版本 ([75c552c](https://github.com/42how-dev/wangEditor/commit/75c552cc8ed54765bebb86a7ec5329a7fc79e85f))
* 更新了 basic-module 依赖版本 ([20c9543](https://github.com/42how-dev/wangEditor/commit/20c9543dc9249af6fc7e3a9895ed7f64709ca6ee))
* 兼容 word 文字背景色 ([e820b26](https://github.com/42how-dev/wangEditor/commit/e820b26730d34480994a343ab262c043c30a4495))
* 禁用时 image 的样式 ([42c993a](https://github.com/42how-dev/wangEditor/commit/42c993a7668d90ce049b88a01df21b28912c679f))
* 全选设置字体报错 ([cdb14d1](https://github.com/42how-dev/wangEditor/commit/cdb14d10330b5736534e7aaf3a070df2804a8be2))
* 上下标文案显示 ([0e97da1](https://github.com/42how-dev/wangEditor/commit/0e97da18279cee6ea06c217972fee4faf9e4758f))
* 添加链接,空格也会在链接中的问题 ([c656827](https://github.com/42how-dev/wangEditor/commit/c65682743bd49eba9ab64be847f1f9527fb6170b))
* 图片 100% 有横向滚动条 ([d21322a](https://github.com/42how-dev/wangEditor/commit/d21322a1a9f2e3172a1bd5e175f5ebbb5f2ed074))
...
* 修复多选文字且选择空白行无法修改文字样式 ([99a9150](https://github.com/42how-dev/wangEditor/commit/99a91509c6e12220bb105cc6d15a0f0a4b375cea))
* 修复光标状态下设置文字样式,菜单不 active 的问题 ([b1b2dba](https://github.com/42how-dev/wangEditor/commit/b1b2dbaaae11f74bd36ec79ff50de336c252fef5))
* 修复清除格式不完全的问题 ([1181a23](https://github.com/42how-dev/wangEditor/commit/1181a23e6de71162dc490d9b348379c9b2ef4251))
* 修复设置文字颜色与背景色行为与预期不一致的问题 ([25d3381](https://github.com/42how-dev/wangEditor/commit/25d3381aa65ce8fe862617e7b1b03cfa5370715d))
* 修复在空字符上插入 link 报错的问题 ([e838f06](https://github.com/42how-dev/wangEditor/commit/e838f069f556a5d3206e48a5ed76f8d1e0ae3d05))
* 修复html回显时，部分字体回显问题 ([c83ffa7](https://github.com/42how-dev/wangEditor/commit/c83ffa70da655d03bfd639f2d1fd04986440ead2))
* 选中文字，创建链接（同时修改文字） ([5fdf6ae](https://github.com/42how-dev/wangEditor/commit/5fdf6ae33b1bebe9b7373e4b7ee8c568480a3c08))
...
* 优化 custom-types.d.ts 中类型声明，修复测试文件 ts 报错 ([3a6c455](https://github.com/42how-dev/wangEditor/commit/3a6c4553245bc734dae1e17d605af389971782a2))
* 有内联元素时对齐失败 ([076c694](https://github.com/42how-dev/wangEditor/commit/076c694a4b3474080b89f52692595b84bf4d8207))
...
* code node 顶层 ([a927938](https://github.com/42how-dev/wangEditor/commit/a9279388f14212319505f6a5da300cd15e81c214))
* code-block 换行 - 自动加入前面的空格 ([c214032](https://github.com/42how-dev/wangEditor/commit/c2140327842d803cd18a9acf47ec3225182bf940))
* color toHtml ([2c9718c](https://github.com/42how-dev/wangEditor/commit/2c9718cb2feb4dd0a7bf39238598707fa6d2bb21))
* delete divider ([f04cbd6](https://github.com/42how-dev/wangEditor/commit/f04cbd6009099629e3cd41be19d20b6788fe7f28))
* disabled - img 和 todo 可编辑 ([cf6a3f2](https://github.com/42how-dev/wangEditor/commit/cf6a3f2a1e05b6231f46aa74c422561e4147f7ae))
...
* emptyP toHtml 增加 br ([c347c29](https://github.com/42how-dev/wangEditor/commit/c347c2916416edc96a99d1bf53c0e18cd22d80f9))
* font-size - 支持配置 name value ([206ebd9](https://github.com/42how-dev/wangEditor/commit/206ebd994d2635704d93ef9ebe0022d7d72ddea8))
* getHtml API ([c0b60cf](https://github.com/42how-dev/wangEditor/commit/c0b60cf47d8eaae4292265906fbe07875e1564c9))
* header 不禁用 bold ([f4cd3d0](https://github.com/42how-dev/wangEditor/commit/f4cd3d0b85725701c3ec650e4d6ae7d8831f5105))
...
* image 拖拽，设置最小值 ([0205023](https://github.com/42how-dev/wangEditor/commit/0205023d8c1ec3fafcba3a950afcaef9f5f5170f))
* insert link ([a104682](https://github.com/42how-dev/wangEditor/commit/a10468279f730c9a4216474cf3d44d41f124cb6b))
* insertHtml - 空行 ([53a8fbb](https://github.com/42how-dev/wangEditor/commit/53a8fbb5cf665ef0d6f7fd1c2fee73dba0d98e32))
* insertHtml - 空行 ([c61f415](https://github.com/42how-dev/wangEditor/commit/c61f415c41d393f203ae5e5c17d9167ec60a1824))
* issue 4308 - 自定义字号、字体无法回显 ([ad38b8c](https://github.com/42how-dev/wangEditor/commit/ad38b8ce6dbcff1d65785c8d6701238ad351f562))
* justify - disable ([3a4b24e](https://github.com/42how-dev/wangEditor/commit/3a4b24e8e628024de248f0b52bb4066f626e7480))
* justify indent ([5a81e52](https://github.com/42how-dev/wangEditor/commit/5a81e527a45e7a92eb36a2aefa50d93e20c4cec2))
* justify menu disabled ([19e2f80](https://github.com/42how-dev/wangEditor/commit/19e2f8008a435101c6ecd4d4a7eadd423cb1070f))
* link 无文本 ([af4fb32](https://github.com/42how-dev/wangEditor/commit/af4fb3218bd4651763f66c804fec2b872e99e8f3))
* link, text hoverbar 选区问题 ([e0b7438](https://github.com/42how-dev/wangEditor/commit/e0b7438c89a347f1b0b940d9c11150b72d595529))
* lodash.throttle 引用 bug ([50aeff9](https://github.com/42how-dev/wangEditor/commit/50aeff94859bf328346cb9cfe89d0abd57c3b641))
...
* parse indent style 负数 ([c8d746e](https://github.com/42how-dev/wangEditor/commit/c8d746e0464bdda626313c17af4d015681ccc3e8))
* parse-html - sub sup ([2c15a5f](https://github.com/42how-dev/wangEditor/commit/2c15a5f9c9c2de8b34770a6bebfe765d203a03f6))
* parse-html pre/code ([d9bd773](https://github.com/42how-dev/wangEditor/commit/d9bd773f9a40f9531d9163700253d0b5f717afb8))
...
* 测试 ([2392583](https://github.com/42how-dev/wangEditor/commit/239258318b1e734eb23b801c31373f4cad876765))
...
* 增加 header4 header5 ([cc48734](https://github.com/42how-dev/wangEditor/commit/cc4873412ce3f4de1ecc1dbf4c313094dceb5a77))
...
* insertHtml - text style ([6f303c5](https://github.com/42how-dev/wangEditor/commit/6f303c5be81dc8763a28bc982928e5bc9f2936d9))
* link menu config ([fe6b6db](https://github.com/42how-dev/wangEditor/commit/fe6b6db62086a5014c25ea96aa9308c2028a5b60))
...
* placeholder ([a3e4cdc](https://github.com/42how-dev/wangEditor/commit/a3e4cdcd474063e4f436327aaf4074bb2126d941))
...
* 优化较大的svg图片 ([2c360e7](https://github.com/42how-dev/wangEditor/commit/2c360e7628eb655e8df67cc7b764f4981b283a2f))





## [1.1.7](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.6...@42how/basic-modules@1.1.7) (2022-11-14)
...
## [1.1.6](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.5...@42how/basic-modules@1.1.6) (2022-09-27)

**Note:** Version bump only for package @42how/basic-modules





## [1.1.5](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.4...@42how/basic-modules@1.1.5) (2022-09-15)
...
## [1.1.4](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.3...@42how/basic-modules@1.1.4) (2022-09-14)
...
## [1.1.3](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.2...@42how/basic-modules@1.1.3) (2022-07-13)
...
## [1.1.2](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.1...@42how/basic-modules@1.1.2) (2022-07-11)
...
## [1.1.1](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.1.0...@42how/basic-modules@1.1.1) (2022-06-02)
...
# [1.1.0](https://github.com/wangeditor-team/wangEditor/compare/@42how/basic-modules@1.0.1...@42how/basic-modules@1.1.0) (2022-05-25)
